# Atlas 1.0.2 — install and first run
...
1. Download `Atlas_1.0.2_x64-setup.exe` from the [latest release](https://github.com/17sh8dy/Atlas/releases/latest).
2. Run it and follow the steps.
3. Atlas starts. Press **Ctrl+Space** anywhere to summon or hide it.

### "Windows protected your PC"

Atlas 1.0.2 is **not code-signed yet**, so Windows SmartScreen shows a blue warning the first time.
...
```powershell
Get-FileHash .\Atlas_1.0.2_x64-setup.exe -Algorithm SHA256
```
